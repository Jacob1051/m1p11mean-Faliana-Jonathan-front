...
var BeautyZone = (function () {
                ...
                if ($target.length > 0) {
                    jQuery("html, body")
                        ...
                        .animate(
                            {
                                scrollTop:
                                    $target.offset().top - headerFullHeight,
                            },
                            500,
                            "swing",
                            function () {
    ...
    var pageOnScroll = function (event) {
        ...
        jQuery(".navbar-nav-scroll > li").each(function () {
            ...
            if (
                refElement.offset().top - headerFullHeight - 20 <= scrollPos &&
                refElement.offset().top + refElement.height() > scrollPos
            ) {
                jQuery(".navbar-nav-scroll a")
                    .parent("li")
                    .removeClass("active");
...
window.closeSidebar = () => {
    $(".nav.navbar-nav li a[routerlink]").on("click", () => {
        console.log("clicked");
    });
};
